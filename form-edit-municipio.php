      ...
      <div class="row">
        <div class="col-md-12 bg-light">
            <div class="py-5 bg-light">
              ...
              <form action="edit-municipio.php" method="post">
                <div class="form-group">
                  <?php
                    $bd_host="localhost";
                    $bd_user="root";
                    ...
                    $consultar = "SELECT MUN_CL FROM clientes WHERE USERNAME_CL LIKE '$nombre'";
                        ...
                        if ($resultado = mysqli_query($conectar, $consultar))
                        {
                            ...
                            <h1>Datos del usuario</h1>
                              <div class='form-group'>
                                <label class='title'>Municipio actual</label>
                                <br><p id='data'> %s </p>
                                <label>Municipio nuevo</label>
                                <input class='form-control' placeholder='ingresa tu nuevo municipio' name='MUN_CL' required='required' type='text' required> 
                                </div>
