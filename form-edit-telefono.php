      ...
      <div class="row">
        <div class="col-md-12 bg-light">
            <div class="py-5 bg-light">
              ...
              <form action="edit-telefono.php" method="post">
                <div class="form-group">
                  <?php
                    $bd_host="localhost";
                    $bd_user="root";
                    ...
                    $consultar = "SELECT TEL_CL FROM clientes WHERE USERNAME_CL LIKE '$nombre'";
                        ...
                        if ($resultado = mysqli_query($conectar, $consultar))
                        {
                            ...
                            <h1>Datos del usuario</h1>
                              <div class='form-group'>
                                <label class='title'>Telefono actual</label>
                                <br><p id='data'> %s </p>
                                <label>Telefono nuevo</label>
                                <input class='form-control' placeholder='ingresa tu nuevo telefono' name='TEL_CL' required='required' type='text'> 
                                </div>
