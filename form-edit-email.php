            ...
            <div class="py-5 bg-light">
                ...
                <form action="edit-email.php" method="post">
                  <?php
                    ...
                    $consultar = "SELECT EMAIL_CL FROM clientes WHERE USERNAME_CL LIKE '$nombre'";
                        ...
                        if ($resultado = mysqli_query($conectar, $consultar))
                        {
                            ...
                            <h1>Datos del usuario</h1>
                              <div class='form-group'>
                                ...
                                <label class='title'>Email actual</label>
                                <br><p id='data'> %s </p>
                                <label>Email nuevo</label>
                                <input class='form-control' placeholder='ingresa tu nuevo correo' name='EMAIL_CL' required='required' type='text' required> 
                                </div>
